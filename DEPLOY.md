...
- `NEXT_PUBLIC_MARKETING_SITE_URL` (optional — CORS origin for `POST /api/g-usdm-quote`; defaults to `https://goclaim.xyz`; apex and www variants are both allowed automatically)
...
- `cronSchedule = "0 12 * * *"` — daily at 12:00 UTC (3:00 PM EAT / UTC+3).
