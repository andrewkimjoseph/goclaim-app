...
export const copy = {
  ...
  time: {
    claimScheduleUtc: "daily at 6:00 PM EAT",
    claimScheduleShort: "6:00 PM EAT daily",
  ...
  faqs: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Every day at 6:00 PM EAT (East Africa Time). G$ is sent to your wallet right after each GoClaim.",
      },
      {
